    ...
    return (
        <>
            <section id="sell-propriety">
                <div className="container bg-primary-200 text-white mx-auto flex flex-col-reverse items-center text-center justify-center gap-7 md:flex-row-reverse px-10 py-5">
